...
public class Category_Module {
	...
	Thread.sleep(4000);
	driver.findElement(By.xpath("//input[@placeholder=\"Enter category name\"]")).sendKeys("Category-20");
	driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[2]/div/form/div[5]/button[2]")).click();
	String tittle = driver.getTitle();
	Thread.sleep(4000);
	Assert.assertEquals(tittle, "Category Management | pt.Track");
	}
	...
	public void Edit_category() throws InterruptedException {
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("//input[@placeholder=\"Enter category name\"]")).sendKeys("A_Div16");
		Thread.sleep(4000);
	...
	@Test
	public void Archive_category() throws InterruptedException{
	...
	public void Search_category() throws InterruptedException{
		...
		for (WebElement searchby : searchBy) {
			if (searchby.getText().equals("Category")) {
		...
		driver.findElement(By.id("searchText")).sendKeys("Beef");
		Thread.sleep(4000);
		...
		for (int i=0; i<results.size(); i++) {
			...
			if (results.get(i).getText().contains("Beef")) {
